...
<body>
    ...
    <section class="hero-section">
        <div class="container">
            <div class="fade-in">
                <h1 class="hero-title"><i class="bi bi-stars"></i> فروشگاه حرفه ای کتونی</h1>
                <p class="hero-subtitle">مینیمال، سریع، ریسپانسیو و آماده فروش</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-4">
        <div class="container">
            ...
            <div class="category-menu fade-in">
                <a href="index.php?category=all" class="category-chip <?php echo $selectedCategory === 'all' ? 'is-active' : ''; ?>">
                    همه محصولات
                </a>
